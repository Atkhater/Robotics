...
class MoveGroupPythonInterfaceTutorial(object):
   ...
   def go_to_joint_state(self):
       ...
       joint_goal[0] = -57/360*tau
       joint_goal[1] = -2/360*tau
       joint_goal[2] = 57/360*tau
       joint_goal[3] = -137/360*tau
       joint_goal[4] = 2/360*tau
       joint_goal[5] = 138/360*tau
       joint_goal[6] = 57/360*tau
   ...
   def go_to_joint_state2(self):
       ...
       # We get the joint values from the group and change some of the values:
       joint_goal = move_group.get_current_joint_values()
       joint_goal[0] = -49/360*tau
       joint_goal[1] = -79/360*tau
       joint_goal[2] = 89/360*tau
       joint_goal[3] = -67/360*tau
       joint_goal[4] = 77/360*tau
       joint_goal[5] = 86/360*tau
       joint_goal[6] = 123/360*tau
   ...
   def add_box3(self, timeout=4):
       ...
       box_pose.header.frame_id = "world"
       box_pose.pose.orientation.w = 1.0
       box_pose.pose.position.z = 0.15  # above the panda_hand frame
       box_pose.pose.position.x = 0.5  # above the panda_hand frame
       box_name = "box3"
...
def main():   
   try:
       ...
       input("============ Press `Enter` to add a box 2 to the planning scene ...")
       tutorial.add_box2()


       input("============ Press `Enter` to add a box 3 to the planning scene ...")
       tutorial.add_box3()


       input(
           "============ Press `Enter` to go to initial state ..."
       )
       ...
       input("============ Press `Enter` to go to final state ...")
